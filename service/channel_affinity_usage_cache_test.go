...
func uniqueChannelAffinityStatsKey(t *testing.T) (string, string) {
	t.Helper()
	key := strings.NewReplacer("/", "_", " ", "_").Replace(t.Name())
	return "rule_" + key, "fp_" + key
}
...
func TestObserveChannelAffinityUsageCacheByRelayFormat_ClaudeMode(t *testing.T) {
	ruleName, keyFP := uniqueChannelAffinityStatsKey(t)
	usingGroup := "default"
